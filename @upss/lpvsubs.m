...
% LPVSUBS  Evaluate UPSS at point in the domain, and demote results to USS.
%
% B = LPVSUBS(A,NAME,VALUES,METHOD) evaluates a UPSS A at the domain points
...
% Interpolate stacked state-space matrices using UPMAT/LPVINTERP
M = [upmat(A,Domain) upmat(B,Domain); upmat(C,Domain) upmat(D,Domain)];
